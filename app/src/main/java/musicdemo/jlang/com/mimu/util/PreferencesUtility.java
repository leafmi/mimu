...
public class PreferencesUtility {
    ...
    //Music Play Status
    private static final String KEY_CURRENT_PLAYING_LIST_ID = "current_playing_list_id"; //当前播放歌单的的数据来源歌单Id
    private static final String KEY_MUSIC_PLAY_STATUS = "music_play_status"; //音乐的播放状态
    private static final String KEY_MUSIC_PLAY_MODEL = "music_play_model"; //音乐的播放模式
...
//
    ...
    public int getMusicPlayStatus() {
        return mPreferences.getInt(KEY_MUSIC_PLAY_STATUS, AudioPlayerManager.STOP);
    }

    public void setMusicPlayStatus(int status) {
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(KEY_MUSIC_PLAY_STATUS, status);
        editor.apply();
    }

    public int getMusicPlayModel() {
        return mPreferences.getInt(KEY_MUSIC_PLAY_MODEL, 0);
    }

    public void setMusicPlayModel(int model) {
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(KEY_MUSIC_PLAY_MODEL, model);
        editor.apply();
    }

    public int getCurrentPlayingListSourceId() {
        return mPreferences.getInt(KEY_CURRENT_PLAYING_LIST_ID, 0);
    }

    public void setCurrentPlayingListSourceId(int sourceId){
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(KEY_CURRENT_PLAYING_LIST_ID, sourceId);
        editor.apply();
    }
}
